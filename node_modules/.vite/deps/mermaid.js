...
import {
  selectSvgElement
} from "./chunk-F2WRR752.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-6UTPL3DK.js";
import {
  registerLayoutLoaders
} from "./chunk-M6F6FPQE.js";
import "./chunk-NENRJIJ6.js";
import "./chunk-MXWKPBPC.js";
import "./chunk-YSJ4DDSW.js";
import "./chunk-4DSS2CEP.js";
import {
  registerIconPacks
} from "./chunk-2JWAYHUF.js";
import {
  dedent
} from "./chunk-G4NLKJKA.js";
import {
  isEmpty_default
...
import {
  ...
  removeDirectives,
  utils_default
} from "./chunk-PYJQUYAU.js";
import "./chunk-F2AQKPUI.js";
import {
  UnknownDiagramError,
  __name,
  addDirective,
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-6F5ED5ID-S6AOBBNZ.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-7ASYPVHJ-64CKJ4K3.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-6RL3IURR-YTJBW3JJ.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NRZ2UAAF-EWW6DLWC.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-NTVNEXSI-OFDBZBH4.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-A4XQUW5V-OSJ3LUB2.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-YF2LJOPJ-YECHG66Y.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-OS5C2QUG-34WICWMU.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-6QU3TZC5-XMUATFUL.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-MIRIMTAZ-7LZWPGYD.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-G6AWOVSC-EYHGXPSW.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-LNE6IOMH-AGRLRG6F.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-MQ7JQ4JX-4V6NZDD7.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-MAYHULR4-CXZKTVAF.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4JROLMXI-ODIBOV5P.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-G5WM74LC-O2N2XDK4.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-U7ZMHBDA-BLJFH5C6.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-GWI6TPTV-XHFRV3ER.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-QRCXZQQD-PV3HCF2I.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-Y46BX6SQ-WDJMRUS3.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QW4FP2JN-IXSCDYPT.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-ZHA2E4KO-VZCHCUWS.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-UYN6MBPD-TDQA6AF6.js");
